...
artist_table_drop = "DROP TABLE IF EXISTS dimTime;"
...
create_table_queries = [staging_songs_table_create, staging_events_table_create, time_table_create, artist_table_create, user_table_create, song_table_create, songplay_table_create]
